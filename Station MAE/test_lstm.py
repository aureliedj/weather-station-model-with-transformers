...
def main() -> None:
    ...
    from engine.lstm_metrics import aggregate_metrics
    row, persist_row = aggregate_metrics(
        n_sse, n_sae, n_bias, p_sse, p_sae, p_bias, q_sse, cnt, GRID, VARS)
    row = {"checkpoint": args.run_name, **row}
